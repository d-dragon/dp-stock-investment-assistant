...
The UI now provides full visibility and control over OpenAI model selection, completing the integration with the enhanced backend API v1.2.0.# Frontend UI Improvements Summary
