...
| [ADR-004](ADR-AGENT-004-THIN-TOOL-GATEWAY-AND-NORMALIZED-TOOL-CONTEXT.md) | Adopt a Thin Tool Gateway and Normalized Tool Context Boundary | Proposed | 2026-06-22 |
| [ADR-005](ADR-AGENT-005-STRUCTURED-OUTPUT-BOUNDARY-AND-RESPONSE-TOOL-PATTERN.md) | Adopt Route-Adapted Custom Response Tool Pattern and Phased Milestone Strategy for Agent Structured Outputs | Accepted | 2026-07-21 |
