---
name: speckit-understanding-energy
description: '[Experimental] Detect ambiguity hotspots using token-level perplexity
  from a local language model. A second pair of eyes beyond the 31 rule-based metrics.'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: understanding:commands/energy.md
---
