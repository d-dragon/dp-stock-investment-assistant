---
name: speckit-understanding-scan
description: Scan spec for 31 requirements quality metrics across 6 categories (Structure,
  Testability, Readability, Cognitive, Semantic, Behavioral) with quality gates.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: understanding:commands/scan.md
---
